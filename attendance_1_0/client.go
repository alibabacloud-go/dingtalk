...
type GetCheckinRecordByUserResponseBodyResultPageList struct {
	...
	CheckinType    *string                                                           `json:"checkinType,omitempty" xml:"checkinType,omitempty"`
...
func (s *GetCheckinRecordByUserResponseBodyResultPageList) SetCheckinType(v string) *GetCheckinRecordByUserResponseBodyResultPageList {
	s.CheckinType = &v
	return s
}
