...
func (s *HrmMailSendRequestMailMeeting) SetAlarmDesc(v string) *HrmMailSendRequestMailMeeting {
	s.AlarmDesc = &v
	return s
}

func (s *HrmMailSendRequestMailMeeting) SetAlarmMinutes(v int32) *HrmMailSendRequestMailMeeting {
	s.AlarmMinutes = &v
	return s
}
