...
type UpdateRobotStreamAwayAutoReplyTemplateHeaders struct {
	CommonHeaders           map[string]*string `json:"commonHeaders,omitempty" xml:"commonHeaders,omitempty"`
	XAcsDingtalkAccessToken *string            `json:"x-acs-dingtalk-access-token,omitempty" xml:"x-acs-dingtalk-access-token,omitempty"`
}

func (s UpdateRobotStreamAwayAutoReplyTemplateHeaders) String() string {
	return tea.Prettify(s)
}

func (s UpdateRobotStreamAwayAutoReplyTemplateHeaders) GoString() string {
	return s.String()
}

func (s *UpdateRobotStreamAwayAutoReplyTemplateHeaders) SetCommonHeaders(v map[string]*string) *UpdateRobotStreamAwayAutoReplyTemplateHeaders {
	s.CommonHeaders = v
	return s
}

func (s *UpdateRobotStreamAwayAutoReplyTemplateHeaders) SetXAcsDingtalkAccessToken(v string) *UpdateRobotStreamAwayAutoReplyTemplateHeaders {
	s.XAcsDingtalkAccessToken = &v
	return s
}

type UpdateRobotStreamAwayAutoReplyTemplateRequest struct {
...
func (s UpdateRobotStreamAwayAutoReplyTemplateRequest) String() string {
	return tea.Prettify(s)
}

func (s UpdateRobotStreamAwayAutoReplyTemplateRequest) GoString() string {
	return s.String()
}

func (s *UpdateRobotStreamAwayAutoReplyTemplateRequest) SetCardData(v string) *UpdateRobotStreamAwayAutoReplyTemplateRequest {
	s.CardData = &v
	return s
}

func (s *UpdateRobotStreamAwayAutoReplyTemplateRequest) SetCardTemplateId(v string) *UpdateRobotStreamAwayAutoReplyTemplateRequest {
	s.CardTemplateId = &v
	return s
}

func (s *UpdateRobotStreamAwayAutoReplyTemplateRequest) SetRobotCode(v string) *UpdateRobotStreamAwayAutoReplyTemplateRequest {
	s.RobotCode = &v
	return s
}

type UpdateRobotStreamAwayAutoReplyTemplateResponseBody struct {
	Success *bool `json:"success,omitempty" xml:"success,omitempty"`
}

func (s UpdateRobotStreamAwayAutoReplyTemplateResponseBody) String() string {
	return tea.Prettify(s)
}

func (s UpdateRobotStreamAwayAutoReplyTemplateResponseBody) GoString() string {
	return s.String()
}

func (s *UpdateRobotStreamAwayAutoReplyTemplateResponseBody) SetSuccess(v bool) *UpdateRobotStreamAwayAutoReplyTemplateResponseBody {
	s.Success = &v
	return s
}

type UpdateRobotStreamAwayAutoReplyTemplateResponse struct {
	Headers    map[string]*string                                  `json:"headers,omitempty" xml:"headers,omitempty"`
	StatusCode *int32                                              `json:"statusCode,omitempty" xml:"statusCode,omitempty"`
	Body       *UpdateRobotStreamAwayAutoReplyTemplateResponseBody `json:"body,omitempty" xml:"body,omitempty"`
}

func (s UpdateRobotStreamAwayAutoReplyTemplateResponse) String() string {
	return tea.Prettify(s)
}

func (s UpdateRobotStreamAwayAutoReplyTemplateResponse) GoString() string {
	return s.String()
}

func (s *UpdateRobotStreamAwayAutoReplyTemplateResponse) SetHeaders(v map[string]*string) *UpdateRobotStreamAwayAutoReplyTemplateResponse {
	s.Headers = v
	return s
}

func (s *UpdateRobotStreamAwayAutoReplyTemplateResponse) SetStatusCode(v int32) *UpdateRobotStreamAwayAutoReplyTemplateResponse {
	s.StatusCode = &v
	return s
}

func (s *UpdateRobotStreamAwayAutoReplyTemplateResponse) SetBody(v *UpdateRobotStreamAwayAutoReplyTemplateResponseBody) *UpdateRobotStreamAwayAutoReplyTemplateResponse {
	s.Body = v
	return s
}
...
// Summary:
//
// 设置机器人STREAM模式下离线自动回复模版
//
// @param request - UpdateRobotStreamAwayAutoReplyTemplateRequest
//
// @param headers - UpdateRobotStreamAwayAutoReplyTemplateHeaders
//
// @param runtime - runtime options for this request RuntimeOptions
//
// @return UpdateRobotStreamAwayAutoReplyTemplateResponse
func (client *Client) UpdateRobotStreamAwayAutoReplyTemplateWithOptions(request *UpdateRobotStreamAwayAutoReplyTemplateRequest, headers *UpdateRobotStreamAwayAutoReplyTemplateHeaders, runtime *util.RuntimeOptions) (_result *UpdateRobotStreamAwayAutoReplyTemplateResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
	...
	params := &openapi.Params{
		Action:      tea.String("UpdateRobotStreamAwayAutoReplyTemplate"),
		Version:     tea.String("robot_1.0"),
		Protocol:    tea.String("HTTP"),
		Pathname:    tea.String("/v1.0/robot/stream/away/template/update"),
		Method:      tea.String("POST"),
		AuthType:    tea.String("AK"),
		Style:       tea.String("ROA"),
		ReqBodyType: tea.String("none"),
	...
	_result = &UpdateRobotStreamAwayAutoReplyTemplateResponse{}
	_body, _err := client.Execute(params, req, runtime)
	if _err != nil {
		return _result, _err
	}
...
//
// @return UpdateRobotStreamAwayAutoReplyTemplateResponse
func (client *Client) UpdateRobotStreamAwayAutoReplyTemplate(request *UpdateRobotStreamAwayAutoReplyTemplateRequest) (_result *UpdateRobotStreamAwayAutoReplyTemplateResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	headers := &UpdateRobotStreamAwayAutoReplyTemplateHeaders{}
	_result = &UpdateRobotStreamAwayAutoReplyTemplateResponse{}
	_body, _err := client.UpdateRobotStreamAwayAutoReplyTemplateWithOptions(request, headers, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
