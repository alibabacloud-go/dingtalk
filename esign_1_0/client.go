...
type CreateDeveloperRequest struct {
	...
	DingIsvAccessToken *string `json:"dingIsvAccessToken,omitempty" xml:"dingIsvAccessToken,omitempty"`
...
func (s *CreateDeveloperRequest) SetDingCorpId(v string) *CreateDeveloperRequest {
	s.DingCorpId = &v
	return s
}
...
func (s *CreateDeveloperRequest) SetDingIsvAccessToken(v string) *CreateDeveloperRequest {
	s.DingIsvAccessToken = &v
	return s
}

func (s *CreateDeveloperRequest) SetDingSuiteKey(v string) *CreateDeveloperRequest {
	s.DingSuiteKey = &v
	return s
}
...
func (s *GetUserRealnameUrlRequest) SetDingCorpId(v string) *GetUserRealnameUrlRequest {
	s.DingCorpId = &v
	return s
}
...
func (s *GetUserRealnameUrlRequest) SetDingIsvAccessToken(v string) *GetUserRealnameUrlRequest {
	s.DingIsvAccessToken = &v
	return s
}

func (s *GetUserRealnameUrlRequest) SetDingSuiteKey(v string) *GetUserRealnameUrlRequest {
	s.DingSuiteKey = &v
	return s
}
...
func (s *GetCorpRealnameUrlRequest) SetDingCorpId(v string) *GetCorpRealnameUrlRequest {
	s.DingCorpId = &v
	return s
}
...
func (s *GetCorpRealnameUrlRequest) SetDingIsvAccessToken(v string) *GetCorpRealnameUrlRequest {
	s.DingIsvAccessToken = &v
	return s
}

func (s *GetCorpRealnameUrlRequest) SetDingSuiteKey(v string) *GetCorpRealnameUrlRequest {
	s.DingSuiteKey = &v
	return s
}
...
func (s *AuthUrlRequest) SetDingCorpId(v string) *AuthUrlRequest {
	s.DingCorpId = &v
	return s
}

func (s *AuthUrlRequest) SetDingIsvAccessToken(v string) *AuthUrlRequest {
	s.DingIsvAccessToken = &v
	return s
}

func (s *AuthUrlRequest) SetDingSuiteKey(v string) *AuthUrlRequest {
	s.DingSuiteKey = &v
	return s
}
...
func (s *GetSignNoticeUrlRequest) SetDingCorpId(v string) *GetSignNoticeUrlRequest {
	s.DingCorpId = &v
	return s
}
...
func (s *GetSignNoticeUrlRequest) SetDingSuiteKey(v string) *GetSignNoticeUrlRequest {
	s.DingSuiteKey = &v
	return s
}

func (s *GetSignNoticeUrlRequest) SetDingIsvAccessToken(v string) *GetSignNoticeUrlRequest {
	s.DingIsvAccessToken = &v
	return s
}
...
func (s *GetUploadUrlRequest) SetDingCorpId(v string) *GetUploadUrlRequest {
	s.DingCorpId = &v
	return s
}

func (s *GetUploadUrlRequest) SetDingIsvAccessToken(v string) *GetUploadUrlRequest {
	s.DingIsvAccessToken = &v
	return s
}

func (s *GetUploadUrlRequest) SetDingSuiteKey(v string) *GetUploadUrlRequest {
	s.DingSuiteKey = &v
	return s
}
...
func (s *GetProcessStartUrlRequest) SetDingCorpId(v string) *GetProcessStartUrlRequest {
	s.DingCorpId = &v
	return s
}
...
func (s *GetProcessStartUrlRequest) SetDingIsvAccessToken(v string) *GetProcessStartUrlRequest {
	s.DingIsvAccessToken = &v
	return s
}

func (s *GetProcessStartUrlRequest) SetDingSuiteKey(v string) *GetProcessStartUrlRequest {
	s.DingSuiteKey = &v
	return s
}
...
func (s *GetProcessStartUrlRequestParticipants) SetDingCorpId(v string) *GetProcessStartUrlRequestParticipants {
	s.DingCorpId = &v
	return s
}
...
func (s *GetProcessStartUrlRequestCcs) SetDingCorpId(v string) *GetProcessStartUrlRequestCcs {
	s.DingCorpId = &v
	return s
}
...
func (s *ChannelOrderRequest) SetDingCorpId(v string) *ChannelOrderRequest {
	s.DingCorpId = &v
	return s
}
...
func (s *ChannelOrderRequest) SetDingIsvAccessToken(v string) *ChannelOrderRequest {
	s.DingIsvAccessToken = &v
	return s
}

func (s *ChannelOrderRequest) SetDingSuiteKey(v string) *ChannelOrderRequest {
	s.DingSuiteKey = &v
	return s
}
...
func (s *OrderResaleRequest) SetDingCorpId(v string) *OrderResaleRequest {
	s.DingCorpId = &v
	return s
}
...
func (s *OrderResaleRequest) SetDingIsvAccessToken(v string) *OrderResaleRequest {
	s.DingIsvAccessToken = &v
	return s
}

func (s *OrderResaleRequest) SetDingSuiteKey(v string) *OrderResaleRequest {
	s.DingSuiteKey = &v
	return s
}
...
func (client *Client) CreateDeveloperWithOptions(request *CreateDeveloperRequest, headers *CreateDeveloperHeaders, runtime *util.RuntimeOptions) (_result *CreateDeveloperResponse, _err error) {
	...
	if !tea.BoolValue(util.IsUnset(request.DingIsvAccessToken)) {
