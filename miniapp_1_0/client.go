...
func (s *CreateVersionAcrossBundleRequest) SetDingTokenGrantType(v int64) *CreateVersionAcrossBundleRequest {
...
func (s *CreateVersionAcrossBundleRequest) SetDingOrgId(v int64) *CreateVersionAcrossBundleRequest {
	s.DingOrgId = &v
	return s
}

func (s *CreateVersionAcrossBundleRequest) SetDingCorpId(v string) *CreateVersionAcrossBundleRequest {
	s.DingCorpId = &v
	return s
}
...
func (s *CreateVersionAcrossBundleRequest) SetDingClientId(v string) *CreateVersionAcrossBundleRequest {
	s.DingClientId = &v
	return s
}

func (s *CreateVersionAcrossBundleRequest) SetDingIsvOrgId(v int64) *CreateVersionAcrossBundleRequest {
	s.DingIsvOrgId = &v
	return s
}

func (s *CreateVersionAcrossBundleRequest) SetDingSuiteKey(v string) *CreateVersionAcrossBundleRequest {
	s.DingSuiteKey = &v
	return s
}
...
func (s *UpdateVersionStatusRequest) SetDingClientId(v string) *UpdateVersionStatusRequest {
	s.DingClientId = &v
	return s
}

func (s *UpdateVersionStatusRequest) SetDingTokenGrantType(v int64) *UpdateVersionStatusRequest {
	s.DingTokenGrantType = &v
	return s
}

func (s *UpdateVersionStatusRequest) SetDingOrgId(v int64) *UpdateVersionStatusRequest {
	s.DingOrgId = &v
	return s
}

func (s *UpdateVersionStatusRequest) SetDingIsvOrgId(v int64) *UpdateVersionStatusRequest {
	s.DingIsvOrgId = &v
	return s
}

func (s *UpdateVersionStatusRequest) SetDingSuiteKey(v string) *UpdateVersionStatusRequest {
	s.DingSuiteKey = &v
	return s
}

func (s *UpdateVersionStatusRequest) SetDingCorpId(v string) *UpdateVersionStatusRequest {
	s.DingCorpId = &v
	return s
}
...
func (s *SetExtendSettingRequest) SetDingIsvOrgId(v int64) *SetExtendSettingRequest {
	s.DingIsvOrgId = &v
	return s
}

func (s *SetExtendSettingRequest) SetDingOrgId(v int64) *SetExtendSettingRequest {
	s.DingOrgId = &v
	return s
}

func (s *SetExtendSettingRequest) SetDingSuiteKey(v string) *SetExtendSettingRequest {
	s.DingSuiteKey = &v
	return s
}

func (s *SetExtendSettingRequest) SetDingCorpId(v string) *SetExtendSettingRequest {
	s.DingCorpId = &v
	return s
}

func (s *SetExtendSettingRequest) SetDingTokenGrantType(v int64) *SetExtendSettingRequest {
	s.DingTokenGrantType = &v
	return s
}

func (s *SetExtendSettingRequest) SetDingClientId(v string) *SetExtendSettingRequest {
	s.DingClientId = &v
	return s
}
...
func (s *CreateMiniAppRequest) SetDingIsvOrgId(v int64) *CreateMiniAppRequest {
	s.DingIsvOrgId = &v
	return s
}

func (s *CreateMiniAppRequest) SetDingOrgId(v int64) *CreateMiniAppRequest {
	s.DingOrgId = &v
	return s
}

func (s *CreateMiniAppRequest) SetDingSuiteKey(v string) *CreateMiniAppRequest {
	s.DingSuiteKey = &v
	return s
}

func (s *CreateMiniAppRequest) SetDingCorpId(v string) *CreateMiniAppRequest {
	s.DingCorpId = &v
	return s
}

func (s *CreateMiniAppRequest) SetDingTokenGrantType(v int64) *CreateMiniAppRequest {
	s.DingTokenGrantType = &v
	return s
}

func (s *CreateMiniAppRequest) SetDingClientId(v string) *CreateMiniAppRequest {
	s.DingClientId = &v
	return s
}
...
func (s *CreateMiniAppPluginRequest) SetDingIsvOrgId(v int64) *CreateMiniAppPluginRequest {
	s.DingIsvOrgId = &v
	return s
}

func (s *CreateMiniAppPluginRequest) SetDingOrgId(v int64) *CreateMiniAppPluginRequest {
	s.DingOrgId = &v
	return s
}

func (s *CreateMiniAppPluginRequest) SetDingSuiteKey(v string) *CreateMiniAppPluginRequest {
	s.DingSuiteKey = &v
	return s
}

func (s *CreateMiniAppPluginRequest) SetDingCorpId(v string) *CreateMiniAppPluginRequest {
	s.DingCorpId = &v
	return s
}

func (s *CreateMiniAppPluginRequest) SetDingTokenGrantType(v int64) *CreateMiniAppPluginRequest {
	s.DingTokenGrantType = &v
	return s
}

func (s *CreateMiniAppPluginRequest) SetDingClientId(v string) *CreateMiniAppPluginRequest {
	s.DingClientId = &v
	return s
}
...
func (s *ListAvaiableVersionRequest) SetDingIsvOrgId(v int64) *ListAvaiableVersionRequest {
	s.DingIsvOrgId = &v
	return s
}

func (s *ListAvaiableVersionRequest) SetDingOrgId(v int64) *ListAvaiableVersionRequest {
	s.DingOrgId = &v
	return s
}

func (s *ListAvaiableVersionRequest) SetDingSuiteKey(v string) *ListAvaiableVersionRequest {
	s.DingSuiteKey = &v
	return s
}

func (s *ListAvaiableVersionRequest) SetDingCorpId(v string) *ListAvaiableVersionRequest {
	s.DingCorpId = &v
	return s
}

func (s *ListAvaiableVersionRequest) SetDingClientId(v string) *ListAvaiableVersionRequest {
	s.DingClientId = &v
	return s
}

func (s *ListAvaiableVersionRequest) SetDingTokenGrantType(v int64) *ListAvaiableVersionRequest {
	s.DingTokenGrantType = &v
	return s
}
...
func (s *InvokeHtmlBundleBuildRequest) SetDingIsvOrgId(v int64) *InvokeHtmlBundleBuildRequest {
	s.DingIsvOrgId = &v
	return s
}

func (s *InvokeHtmlBundleBuildRequest) SetDingOrgId(v int64) *InvokeHtmlBundleBuildRequest {
	s.DingOrgId = &v
	return s
}

func (s *InvokeHtmlBundleBuildRequest) SetDingSuiteKey(v string) *InvokeHtmlBundleBuildRequest {
	s.DingSuiteKey = &v
	return s
}

func (s *InvokeHtmlBundleBuildRequest) SetDingCorpId(v string) *InvokeHtmlBundleBuildRequest {
	s.DingCorpId = &v
	return s
}

func (s *InvokeHtmlBundleBuildRequest) SetDingTokenGrantType(v int64) *InvokeHtmlBundleBuildRequest {
	s.DingTokenGrantType = &v
	return s
}

func (s *InvokeHtmlBundleBuildRequest) SetDingClientId(v string) *InvokeHtmlBundleBuildRequest {
	s.DingClientId = &v
	return s
}
